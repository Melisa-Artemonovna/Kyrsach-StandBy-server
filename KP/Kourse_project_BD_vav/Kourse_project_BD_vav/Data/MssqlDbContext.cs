    ...
    public class MssqlDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Client>(entity =>
            {
                ...
                entity.Property(c => c.registration_date).HasDefaultValueSql("GETDATE()");
            });
            ...
            modelBuilder.Entity<Realtor>(entity =>
            {
                ...
                entity.Property(r => r.hire_date).HasDefaultValueSql("GETDATE()");
            });
            ...
            modelBuilder.Entity<UserActivity>(entity =>
            {
                ...
                entity.Property(a => a.activity_type).HasMaxLength(50).IsRequired();
                entity.Property(a => a.description).HasMaxLength(255);
                entity.Property(a => a.created_at).HasDefaultValueSql("GETDATE()");
            });
            ...
            modelBuilder.Entity<PropertyReservation>(entity =>
            {
                ...
                entity.Property(pr => pr.reservation_date).HasDefaultValueSql("GETDATE()");
